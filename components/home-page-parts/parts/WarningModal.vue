<script setup lang="ts">
  ...
  onBeforeUnmount(() => {
    home.showWarningModal = false
  })
</script>

<template>
  <TransitionRoot as="template" :show="!auth.isAuthenticated && !home.showWarningModal">
                ...
                <div>
                  <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left flex flex-col gap-8">
                    ...
                    <div class="flex justify-center items-center gap-8">
                      <button class="exit-bth" @click="goHomePage">Авторизируйтесь</button>
                    </div>
                  </div>
                </div>
              </div>
